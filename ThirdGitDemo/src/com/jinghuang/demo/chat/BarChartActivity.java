...
import com.jinghuang.demo.chat.custom.MyYAxisValueFormatter;
...
public class BarChartActivity extends DemoBase implements OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mChart.setDrawBarShadow(true);  // 不需要，每个bar距离最大值会肯绘制一个虚线的bar
        ...
        //xAxis.setDrawGridLines(true);   // 多了X轴的竖线
        xAxis.setSpaceBetweenLabels(1); // 间隔几个显示x轴坐标
        ...
        leftAxis.setLabelCount(8, false);   //Y轴坐标个数
        leftAxis.setValueFormatter(custom);
        leftAxis.setPosition(YAxisLabelPosition.OUTSIDE_CHART);
        leftAxis.setSpaceTop(10f);  // 设置图表中的最高值的顶部间距占最高值的值的百分比 Default10%
        leftAxis.setDrawGridLines(true);
        leftAxis.setEnabled(true);  // Default
        ...
        rightAxis.setDrawGridLines(true);   // Default
        rightAxis.setEnabled(false);

        Legend l = mChart.getLegend();
        //l.setEnabled(false);    // 是否显示图列
    ...
    /**
     *
     * BarEntry(float val, int xIndex) 为具体的点 xIndex为x轴，val为y轴
     * BarData 为x、y轴所有数据的集合
     *
     * @param count x轴
     * @param range y轴
     */
